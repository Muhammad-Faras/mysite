# Generated by Django 5.0.3 on 2024-05-29 03:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('main_skill', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subskills', to='accounts.skill')),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
                ...
                ('birthday', models.DateField(validators=[accounts.models.age_validator])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('main_skill', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.skill')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sub_skill', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.subskill')),
